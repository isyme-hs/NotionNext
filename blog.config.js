...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://marble-steel-aa8.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '2a7024d2068a821d8db5818c8419c084',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ISYME', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的人🌟🔥', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.csdn.net/weixin_63107823', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ISYME, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '你好，我是一个程序员, 你好，我是一个打工人,你好，我是一个干饭人,欢迎来到我的博客🎉',
